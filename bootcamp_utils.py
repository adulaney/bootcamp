...
def draw_bs_reps(data, func, size=1, interval=[2.5, 97.5]):
    """
    Generates bootstrap replicas of data for desired statistic.
    """
    n = len(data)
    ...
    conf_int = np.percentile(bs_replicates_1975, interval)
